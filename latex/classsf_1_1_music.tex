...
\subsubsection[{on\-Get\-Data}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf bool} sf\-::\-Music\-::on\-Get\-Data (
\begin{DoxyParamCaption}
\item[{{\bf Chunk} \&}]{data}
\end{DoxyParamCaption}
...
\subsubsection[{open\-From\-File}]{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} sf\-::\-Music\-::open\-From\-File (
\begin{DoxyParamCaption}
...
This function doesn't start playing the music (call \hyperlink{classsf_1_1_sound_stream_afdc08b69cab5f243d9324940a85a1144}{play()} to do so). See the documentation of \hyperlink{classsf_1_1_input_sound_file}{sf\-::\-Input\-Sound\-File} for the list of supported formats.
...
\subsubsection[{open\-From\-Memory}]{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} sf\-::\-Music\-::open\-From\-Memory (
\begin{DoxyParamCaption}
...
This function doesn't start playing the music (call \hyperlink{classsf_1_1_sound_stream_afdc08b69cab5f243d9324940a85a1144}{play()} to do so). See the documentation of \hyperlink{classsf_1_1_input_sound_file}{sf\-::\-Input\-Sound\-File} for the list of supported formats. Since the music is not loaded completely but rather streamed continuously, the {\itshape data} must remain available as long as the music is playing (i.\-e. you can't deallocate it right after calling this function).
...
\begin{DoxyWarning}{Warning}
Since the music is not loaded at once but rather streamed continuously, the {\itshape data} buffer must remain accessible until the \hyperlink{classsf_1_1_music}{sf\-::\-Music} object loads a new music or is destroyed. That is, you can't deallocate the buffer right after calling this function.
\end{DoxyWarning}
...
\subsubsection[{open\-From\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} sf\-::\-Music\-::open\-From\-Stream (
\begin{DoxyParamCaption}
...
This function doesn't start playing the music (call \hyperlink{classsf_1_1_sound_stream_afdc08b69cab5f243d9324940a85a1144}{play()} to do so). See the documentation of \hyperlink{classsf_1_1_input_sound_file}{sf\-::\-Input\-Sound\-File} for the list of supported formats. Since the music is not loaded completely but rather streamed continuously, the {\itshape stream} must remain alive as long as the music is playing (i.\-e. you can't destroy it right after calling this function).
...
\item 
lib/lapin/dep/\-S\-F\-M\-L-\/2.\-3/include/\-S\-F\-M\-L/\-Audio/\hyperlink{lapin_2dep_2_s_f_m_l-2_83_2include_2_s_f_m_l_2_audio_2_music_8hpp}{Music.\-hpp}\end{DoxyCompactItemize}
