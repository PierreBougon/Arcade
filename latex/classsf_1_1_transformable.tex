...
A note on coordinates and undistorted rendering\-: \par
By default, S\-F\-M\-L (or more exactly, Open\-G\-L) may interpolate drawable objects such as sprites or texts when rendering. While this allows transitions like slow movements or rotations to appear smoothly, it can lead to unwanted results in some cases, for example blurred or distorted objects. In order to render a \hyperlink{classsf_1_1_drawable}{sf\-::\-Drawable} object pixel-\/perfectly, make sure the involved coordinates allow a 1\-:1 mapping of pixels in the window to texels (pixels in the texture). More specifically, this means\-:
\begin{DoxyItemize}
\item The object's position, origin and scale have no fractional part
\item The object's and the view's rotation are a multiple of 90 degrees
\item The view's center and size have no fractional part
\end{DoxyItemize}
...
\subsubsection[{get\-Inverse\-Transform}]{\setlength{\rightskip}{0pt plus 5cm}{\bf const} {\bf Transform}\& sf\-::\-Transformable\-::get\-Inverse\-Transform (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\-Origin}]{\setlength{\rightskip}{0pt plus 5cm}{\bf const} {\bf Vector2f}\& sf\-::\-Transformable\-::get\-Origin (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\-Position}]{\setlength{\rightskip}{0pt plus 5cm}{\bf const} {\bf Vector2f}\& sf\-::\-Transformable\-::get\-Position (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\-Scale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf const} {\bf Vector2f}\& sf\-::\-Transformable\-::get\-Scale (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\-Transform}]{\setlength{\rightskip}{0pt plus 5cm}{\bf const} {\bf Transform}\& sf\-::\-Transformable\-::get\-Transform (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{move}]{\setlength{\rightskip}{0pt plus 5cm}void sf\-::\-Transformable\-::move (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{offset}
\end{DoxyParamCaption}
...
\subsubsection[{scale}]{\setlength{\rightskip}{0pt plus 5cm}void sf\-::\-Transformable\-::scale (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{factor}
\end{DoxyParamCaption}
...
\subsubsection[{set\-Origin}]{\setlength{\rightskip}{0pt plus 5cm}void sf\-::\-Transformable\-::set\-Origin (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{origin}
\end{DoxyParamCaption}
...
\subsubsection[{set\-Position}]{\setlength{\rightskip}{0pt plus 5cm}void sf\-::\-Transformable\-::set\-Position (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{position}
\end{DoxyParamCaption}
...
\subsubsection[{set\-Scale}]{\setlength{\rightskip}{0pt plus 5cm}void sf\-::\-Transformable\-::set\-Scale (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{factors}
\end{DoxyParamCaption}
...
\item 
lib/lapin/dep/\-S\-F\-M\-L-\/2.\-3/include/\-S\-F\-M\-L/\-Graphics/\hyperlink{lapin_2dep_2_s_f_m_l-2_83_2include_2_s_f_m_l_2_graphics_2_transformable_8hpp}{Transformable.\-hpp}\end{DoxyCompactItemize}
