...
\hyperlink{classsf_1_1_rect}{sf\-::\-Rect} is a template and may be used with any numeric type, but for simplicity the instantiations used by S\-F\-M\-L are typedef'd\-: \begin{DoxyItemize}
\item sf\-::\-Rect$<$int$>$ is \hyperlink{namespacesf_a1b1279ab06950b96686cffaacb72fed5}{sf\-::\-Int\-Rect} \item sf\-::\-Rect$<$float$>$ is \hyperlink{namespacesf_ab0d978f5903922a6bdfca1736b71ccc9}{sf\-::\-Float\-Rect}\end{DoxyItemize}
...
\subsubsection[{Rect}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::{\bf Rect} (
...
\item[{{\bf T}}]{rect\-Left, }
\item[{{\bf T}}]{rect\-Top, }
\item[{{\bf T}}]{rect\-Width, }
\item[{{\bf T}}]{rect\-Height}
\end{DoxyParamCaption}
...
\subsubsection[{Rect}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::{\bf Rect} (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2}$<$ {\bf T} $>$ \&}]{position, }
\item[{{\bf const} {\bf Vector2}$<$ {\bf T} $>$ \&}]{size}
\end{DoxyParamCaption}
...
\index{Rect@{Rect}!sf::Rect@{sf\-::\-Rect}}
\subsubsection[{Rect}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ template$<$typename U $>$ {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::{\bf Rect} (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Rect}$<$ U $>$ \&}]{rectangle}
\end{DoxyParamCaption}
...
\index{Rect@{Rect}!sf::Rect@{sf\-::\-Rect}}
\subsubsection[{Rect}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ template$<$typename T $>$ {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::{\bf Rect} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{contains}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ {\bf bool} {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::contains (
\begin{DoxyParamCaption}
\item[{{\bf T}}]{x, }
\item[{{\bf T}}]{y}
\end{DoxyParamCaption}
...
\subsubsection[{contains}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ {\bf bool} {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::contains (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2}$<$ {\bf T} $>$ \&}]{point}
\end{DoxyParamCaption}
...
\subsubsection[{intersects}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ {\bf bool} {\bf sf\-::\-Rect}$<$ {\bf T} $>$\-::intersects (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Rect}$<$ {\bf T} $>$ \&}]{rectangle}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Rect}$<$ {\bf T} $>$ \&}]{rectangle, }
\item[{{\bf Rect}$<$ {\bf T} $>$ \&}]{intersection}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Rect}$<$ {\bf T} $>$ \&}]{left, }
\item[{{\bf const} {\bf Rect}$<$ {\bf T} $>$ \&}]{right}
\end{DoxyParamCaption}
...
\item 
lib/lapin/dep/\-S\-F\-M\-L-\/2.\-3/include/\-S\-F\-M\-L/\-Graphics/\hyperlink{lapin_2dep_2_s_f_m_l-2_83_2include_2_s_f_m_l_2_graphics_2_rect_8hpp}{Rect.\-hpp}\item 
lib/lapin/dep/\-S\-F\-M\-L-\/2.\-3/include/\-S\-F\-M\-L/\-Graphics/\hyperlink{lapin_2dep_2_s_f_m_l-2_83_2include_2_s_f_m_l_2_graphics_2_rect_8inl}{Rect.\-inl}\end{DoxyCompactItemize}
