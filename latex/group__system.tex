...
\hyperlink{group__system_ga7fe7f475639e26334606b5142c29551f}{sf::err}().rdbuf(\hyperlink{internal_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL});
...
Reference to std\-::ostream representing the S\-F\-M\-L error stream 
\end{DoxyReturn}
\hypertarget{group__system_ga9f5460043bdbd5be0ccccd2e6f0ddc41}{\index{System module@{System module}!get\-Native\-Activity@{get\-Native\-Activity}}
\index{get\-Native\-Activity@{get\-Native\-Activity}!System module@{System module}}
\subsubsection[{get\-Native\-Activity}]{\setlength{\rightskip}{0pt plus 5cm}{\bf S\-F\-M\-L\-\_\-\-S\-Y\-S\-T\-E\-M\-\_\-\-A\-P\-I} A\-Native\-Activity$\ast$ sf\-::get\-Native\-Activity (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{group__system_ga9f5460043bdbd5be0ccccd2e6f0ddc41}


Return a pointer to the Android native activity. 

You shouldn't have to use this function, unless you want to implement very specific details, that S\-F\-M\-L doesn't support, or to use a workaround for a known issue.

\begin{DoxyReturn}{Returns}
Pointer to Android native activity structure
\end{DoxyReturn}
\{Android,\hyperlink{_native_activity_8hpp}{S\-F\-M\-L/\-System/\-Native\-Activity.\-hpp}\} \hypertarget{group__system_ga2f2620831533dee0ed432ed982342e09}{\index{System module@{System module}!sleep@{sleep}}
\index{sleep@{sleep}!System module@{System module}}
\subsubsection[{sleep}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf S\-F\-M\-L\-\_\-\-S\-Y\-S\-T\-E\-M\-\_\-\-A\-P\-I} sf\-::sleep (
\begin{DoxyParamCaption}
\item[{Time}]{duration}
\end{DoxyParamCaption}
