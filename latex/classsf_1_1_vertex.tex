...
\subsubsection[{Vertex}]{\setlength{\rightskip}{0pt plus 5cm}sf\-::\-Vertex\-::\-Vertex (
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{the\-Position}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{the\-Position, }
\item[{{\bf const} {\bf Color} \&}]{the\-Color}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{{\bf const} {\bf Vector2f} \&}]{the\-Position, }
\item[{{\bf const} {\bf Vector2f} \&}]{the\-Tex\-Coords}
\end{DoxyParamCaption}
...
\item 
lib/lapin/dep/\-S\-F\-M\-L-\/2.\-3/include/\-S\-F\-M\-L/\-Graphics/\hyperlink{lapin_2dep_2_s_f_m_l-2_83_2include_2_s_f_m_l_2_graphics_2_vertex_8hpp}{Vertex.\-hpp}\end{DoxyCompactItemize}
